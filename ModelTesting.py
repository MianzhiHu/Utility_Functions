...
if __name__ == "__main__":
    ...
    # Load the model
    model = ComputationalModels(model_type='WSLS_delta', task='IGT_SGT')
    result = model.fit(testing_data, initial_EV=[0, 0, 0, 0], initial_mode='first_trial_no_alpha', num_exp_restart=100, num_iterations=1)
