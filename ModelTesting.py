...
if __name__ == "__main__":
    ...
    # model = VisualSearchModels(model_type='hybrid_delta_delta', task='VS')
    # result = model.fit(testing_data, initial_EV=[0, 0], initial_RT=[0, 0], initial_mode='first_trial', num_iterations=1)
