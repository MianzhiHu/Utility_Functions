...
# Parameter bounds for different models
MODEL_BOUNDS = {
    'decay': [(0.0001, 5.0), (0.0001, 0.9999)],
    'delta': [(0.0001, 5.0), (0.0001, 0.9999)],
    'decay_choice': [(0.0001, 5.0), (0.0001, 0.9999)],
    'decay_win': [(0.0001, 5.0), (0.0001, 0.9999)],
    'decay_fre': [(0.0001, 5.0), (0.0001, 0.9999), (-1.0, 1.0)],
    'delta_PVL': [(0.0001, 5.0), (0.0001, 0.9999), (0.0001, 1.0), (0.0001, 5.0)],
    'delta_PVL_relative': [(0.0001, 5.0), (0.0001, 0.9999), (0.0001, 1.0), (0.0001, 5.0)],
    'delta_PVL_relative_RR': [(0.0001, 5.0), (0.0001, 0.9999), (0.0001, 1.0), (0.0001, 5.0)],
...
def get_bounds(model_type, model):
    if model_type == 'decay_fre':
        return [(0.0001, 5.0), (0.0001, 0.9999), (model.beta_lower, model.beta_upper)]

    # models where bounds depend on num_params
    if model_type in ('delta_decay', 'sampler_decay', 'sampler_decay_PE', 'sampler_decay_AV'):
        if model.num_params == 2:
            return [(0.0001, 5.0), (0.0001, 0.9999)]
        elif model.num_params == 3:
            return [(0.0001, 5.0), (0.0001, 0.9999), (0.0001, 0.9999)]

    # fallback: look up from dictionary
    return MODEL_BOUNDS[model_type]
...
def fit_participant(model, participant_id, pdata, model_type, num_iterations=1000,
    ...
    for _ in range(num_iterations):  # Randomly initiate the starting parameter for 1000 times
        ...
        bounds = get_bounds(model_type, model)
